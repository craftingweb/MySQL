...
INSERT INTO Nation (rname, cname) VALUES ('Central Asia', 'Mongolia'), ('Central Asia', 'Tibet'), ('Central Asia', 'Tuva');
INSERT INTO Nation (rname, cname) VALUES ('North Americ', 'Canada'), ('North Americ', 'United States'), ('North Americ', 'Mexico');
INSERT INTO Nation (rname, cname) VALUES ('South Americ', 'Brazil');
INSERT INTO Nation (rname, cname) VALUES ('Europe', 'Norway'), ('Europe', 'Austria'), ('Europe', 'England'), ('Europe', 'Russia');
...
GRANT SELECT ON Nation TO 'api'@'localhost';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CSC315Final2024.* TO 'api'@'localhost';
...
SELECT DISTINCT S.sgname, R.rname 
FROM Band_Styles S 
JOIN (SELECT O.bname, N.rname 
      FROM Band_Origins O 
      JOIN Nation N ON N.cname = O.cname) AS R 
ON S.bname = R.bname;
...
CREATE INDEX Nation_Index ON Nation(cname);
CREATE INDEX Bands_Index ON Bands(bname);
CREATE INDEX BandOrigins_Index ON Band_Origins(bname);
